        ...
        return (
            <div className={`container-a ${this.state.background}`}>
                ...
                <div className='searchBar'>
                    <input id='input' className='searchBarBoth'type='text' placeholder='  Location...' onChange={this.handleChange}></input>
                    <button className='searchBarBoth' onClick={this.handleClick}>
