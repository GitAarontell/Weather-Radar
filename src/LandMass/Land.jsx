...
function Land() {
    ...
    return (
        <div className='landContainer'>
            ...
            <div className='hillOne allHills'></div>
            <div className='hillTwo allHills'></div>
            <div className='hillFour allHills'></div>
            <div className='hillFive allHills'></div>
            <div className='hillSix allHills'></div>
